...
//            if(subjectsArray[i].equals("Lengua")) continue; SE SALTA LA LÍNEA QUE COINCIDE
            System.out.println(subjectsArray[i]);
//            if(subjectsArray[i].equals("Historia")) break; TERMINA EL BUCLE
        }
